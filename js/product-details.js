...
function loadSizeChart(productCategory) {
    const sizeChartContainer = document.querySelector('.size-table-container');
    
    // مسح المحتوى الحالي
    sizeChartContainer.innerHTML = '';
    
    // تحديد صورة جدول المقاسات بناءً على الفئة
    let sizeChartImage = '';
    switch(productCategory) {
        case 'tshirts':
            sizeChartImage = 'size-charts/t-shirt-size-chart.jpg';
            break;
        case 'long-sleeves':
            sizeChartImage = 'size-charts/long-size-chart.jpg';
            break;
        case 'kids-tshirts':
            sizeChartImage = 'images/kids-size-chart.jpg';
            break;
        case 'hoodies':
            sizeChartImage = 'size-charts/hoodies-size-chart.jpg';
            break;
        case 'sweatshirts':
            sizeChartImage = 'images/sweat-size-chart.jpg';
            break;
        case 'tote-bags':
            sizeChartImage = 'size-charts/tote-size-chart.jpg';
            break;
        case 'backpacks':
            sizeChartImage = 'images/backbag-size-chart.jpg';
            break;
        case 'Pouches':
            sizeChartImage = 'images/backbag-size-chart.jpg';
            break;
        default:
            sizeChartImage = 'images/default-size-chart.jpg';
    }
    
    // إنشاء عنصر الصورة وإضافتها
    const img = document.createElement('img');
    img.src = sizeChartImage;
    img.alt = 'جدول المقاسات';
    img.loading = 'lazy';
    img.className = 'size-table-image';
    
    sizeChartContainer.appendChild(img);
}
