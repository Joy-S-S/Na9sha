document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addToCartBtn) {
        addToCartBtn.addEventListener('click', function() {
            ...
            addToCart(productId, productName, productPrice, productImage, quantity, size, color);
...
function updateCartSummary() {
    ...
    // Calculate shipping (free for orders over 200 SAR)
    ...
    if (document.getElementById('order-subtotal')) {
        document.getElementById('order-subtotal').textContent = `${subtotal} ر.س`;
        document.getElementById('order-shipping').textContent = `${shipping} ر.س`;
        document.getElementById('order-total').textContent = `${total} ر.س`;
    }
}